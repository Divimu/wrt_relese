...
remove_unwanted_packages() {
    local luci_packages=(
        ...
        "luci-app-openclash" "luci-app-mihomo" "luci-app-dockerman" "luci-app-adguardhome"
    )
    local packages_net=(
    ...
    local small8_packages=(
        "ppp" "firewall" "dae" "daed" "daed-next" "libnftnl" "nftables" "dnsmasq" "adguardhome" "quickstart" "luci-app-quickstart" "luci-app-adguardhome" "luci-app-dockerman"
    )
